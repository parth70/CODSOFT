...
public class projectonecodesoft{
    public static void main(String[] args) {
        ...
        System.out.println("Welcome in the Number Gate project by parth by codsoft !");
        ...
        while (playAgain) {
            ...
            if (!guessedCorrectly) {
                System.out.println("Sorry dear , best of luck for next time . The number was: " + randomNumber);
            }
